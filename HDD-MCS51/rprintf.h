...
void rprintfu04(unsigned char dat);	///< Print 4-bit hex number. Outputs a single hex character.
void rprintfu08(unsigned char dat);	///< Print 8-bit hex number. Outputs two hex characters.
void rprintfu16(unsigned short dat);	///< Print 16-bit hex number. Outputs four hex characters.
void rprintfu32(unsigned long dat);	///< Print 32-bit hex number. Outputs eight hex characters.
